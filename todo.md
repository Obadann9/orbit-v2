...
- [x] إضافة Pagination وجدول سحوبات قابل للفرز من الخادم والواجهة
- [x] إضافة قسم إعدادات إشعارات للمستخدم مع حفظ أنواع الإشعارات المفعّلة
- [x] تطبيق تفضيلات الإشعارات على إنشاء الإشعارات داخل الخادم
- [x] إضافة اختبارات للترقيم والفرز وحفظ إعدادات الإشعارات
- [x] اختبار metadata وتقسيم الصفحات في Pagination
- [x] اختبار الفرز حسب التاريخ والمبلغ والحالة في الاتجاهين
- [x] اختبار منع إنشاء الإشعارات عند تعطيل النوع المقابل
- [x] تغطية فرز التاريخ والمبلغ والحالة في asc وdesc
- [x] اختبار تدفق إنشاء الإشعار مع تفضيل معطّل بدل اختبار الحارس فقط
- [x] إضافة اختبار تكاملي يمنع سجل notification فعليًا عند تعطيل تفضيل النوع
